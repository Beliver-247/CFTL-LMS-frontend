    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {filteredSubjects.map((subject) => (
          <div
            key={subject.id}
            className="bg-white rounded-xl shadow-md p-4 border hover:shadow-lg transition-shadow relative"
          >
            <h3 className="text-lg font-semibold mb-1">{subject.subjectName}</h3>
