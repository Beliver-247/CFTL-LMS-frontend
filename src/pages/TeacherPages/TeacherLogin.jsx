...
import { FaChalkboardTeacher, FaGoogle, FaEnvelope, FaLock } from 'react-icons/fa';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-xl shadow-lg overflow-hidden">
        <div className="bg-blue-600 py-6 px-8 text-center">
          ...
          <p className="text-blue-100 mt-1">Access your teaching dashboard</p>
        </div>
        ...
        <div className="p-8">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <a href="/teacher-register" className="font-medium text-blue-600 hover:text-blue-500">
                Register here
              </a>
            </p>
          </div>
